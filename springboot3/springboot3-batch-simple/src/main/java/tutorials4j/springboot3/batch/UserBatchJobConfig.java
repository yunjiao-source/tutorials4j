...
import tutorials4j.springboot3.*;
...
public class UserBatchJobConfig {
    ...
    public CompositeItemProcessor<UserCsvRecord, User> compositeProcessor() {
        UserCsvValidator validator = new UserCsvValidator(properties.getNameMinLength(), properties.getNameMaxLength(),
        ...
        compositeProcessor.setDelegates(Arrays.asList(
                validatorItemProcessor,
                transferItemProcessor,
                cleanItemProcessor,
                logItemProcessor
        ));
