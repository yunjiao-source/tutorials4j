package tutorials4j.springboot3.integration.debezium;
...
public class DebeziumListener {
  ...
  private void handleChangeEvent(RecordChangeEvent<SourceRecord> sourceRecordRecordChangeEvent) {
    ...
    //         String record = operation == Operation.DELETE ? BEFORE : AFTER; // Handling Update &
    // Insert operations.
