package tutorials4j.springboot3.cache.app;
...
@EnableCaching
@Configuration
@ComponentScan(basePackages = {"tutorials4j.springboot3.cache.composite"})
@RequiredArgsConstructor
public class CompositeConfig implements CachingConfigurer {
