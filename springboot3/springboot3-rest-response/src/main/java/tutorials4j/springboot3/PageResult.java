...
public class PageResult<T> extends Result<List<T>> implements Serializable {
     ...
     * @param pageSize 每页条数
     */
    private PageResult(Integer code, String message, List<T> data, Long total, Integer totalPage, Integer currentPage, Integer pageSize) {
     ...
     * @param pageSize 每页条数
     */
    public static <T> PageResult<T> pageSuccess(List<T> data, Long total, Integer currentPage, Integer pageSize) {
        // 计算总页数：总条数 ÷ 每页条数，向上取整
