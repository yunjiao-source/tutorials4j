package tutorials4j.microservice.oauth.test;
...
public class Test2Controller {
  ...
  // 测试：查询全部 Access-Token   ---
  // http://localhost:8000/test/getAccessTokenValueList?clientId=1001&loginId=10001
  ...
  // 测试：查询全部 Access-Token, 带过期时间   ---
  // http://localhost:8000/test/getAccessTokenIndexMap?clientId=1001&loginId=10001
  @RequestMapping("/getAccessTokenIndexMap")
  public SaResult getAccessTokenIndexMap(String clientId, long loginId) {
    Map<String, Long> accessTokenIndexMap =
        SaOAuth2Manager.getDao().getAccessTokenIndexMap_FromAdjustAfter(clientId, loginId);
  ...
  // 测试：回收全部 Access-Token   ---
  // http://localhost:8000/test/revokeAccessTokenByIndex?clientId=1001&loginId=10001
  ...
  // 测试：查询全部 Refresh-Token   ---
  // http://localhost:8000/test/getRefreshTokenValueList?clientId=1001&loginId=10001
  ...
  // 测试：查询全部 Refresh-Token, 带过期时间   ---
  // http://localhost:8000/test/getRefreshTokenIndexMap?clientId=1001&loginId=10001
  @RequestMapping("/getRefreshTokenIndexMap")
  public SaResult getRefreshTokenIndexMap(String clientId, long loginId) {
    Map<String, Long> refreshTokenIndexMap =
        SaOAuth2Manager.getDao().getRefreshTokenIndexMap_FromAdjustAfter(clientId, loginId);
    return SaResult.data(refreshTokenIndexMap);
  }

  // 测试：回收指定 Refresh-Token   ---
  // http://localhost:8000/test/revokeRefreshToken?refresh_token=xxxxxxxxxx
  ...
  // 测试：回收全部 Refresh-Token   ---
  // http://localhost:8000/test/revokeRefreshTokenByIndex?clientId=1001&loginId=10001
  ...
  // 测试：查询全部 Client-Token, 带过期时间   ---
  // http://localhost:8000/test/getClientTokenIndexMap?clientId=1001&loginId=10001
  @RequestMapping("/getClientTokenIndexMap")
  public SaResult getClientTokenIndexMap(String clientId, long loginId) {
    Map<String, Long> rlientTokenIndexMap =
        SaOAuth2Manager.getDao().getClientTokenIndexMap_FromAdjustAfter(clientId, loginId);
    return SaResult.data(rlientTokenIndexMap);
  }

  // 测试：回收指定 Client-Token   ---
  // http://localhost:8000/test/revokeClientToken?client_token=xxxxxxxxxxx
