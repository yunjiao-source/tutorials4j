...
import tutorials4j.framework.oauth.satoken.autoconfigure.SaTokenMvcOAuthConfiguration;
...
@Import({
  ...
  OAuthMvcConfiguration.class,
  SaTokenOAuthConfiguration.class,
  SaTokenMvcOAuthConfiguration.class
})
