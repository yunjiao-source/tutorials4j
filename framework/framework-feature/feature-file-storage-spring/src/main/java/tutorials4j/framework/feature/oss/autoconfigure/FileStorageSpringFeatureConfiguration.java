...
@ComponentScan(
    basePackages = {
      "tutorials4j.framework.feature.oss.service",
      "tutorials4j.framework.feature.oss.component",
      "tutorials4j.framework.feature.oss.web"
    })
@EnableJpaRepositories(basePackages = {"tutorials4j.framework.feature.oss.service"})
@EntityScan(basePackages = {"tutorials4j.framework.feature.oss.model"})
