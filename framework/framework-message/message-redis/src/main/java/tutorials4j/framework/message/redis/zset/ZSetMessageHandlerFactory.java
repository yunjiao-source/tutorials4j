 ...
 */
@Slf4j
public class ZSetMessageHandlerFactory {
  public static final ZSetMessageHandlerFactory instance = new ZSetMessageHandlerFactory();
  ...
  public ZSetMessageHandler handler(String key) {
