...
import tutorials4j.framework.core.servlet.CachedBodyRequest;
...
public class CachedBodyController {
    @PostMapping("/body")
    public Map<String, Object> testCachedBody(HttpServletRequest request) throws IOException {
        Map<String, Object> result = new HashMap<>();

        // 检查是否被 CachedBodyFilter 包装
        boolean isCached = request instanceof CachedBodyRequest;
