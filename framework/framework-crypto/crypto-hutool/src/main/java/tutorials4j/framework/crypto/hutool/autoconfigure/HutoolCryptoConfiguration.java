...
public class HutoolCryptoConfiguration {
  ...
  AESCryptoProcessor aesCryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isBlank(secretKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by AESCryptoProcessor");
  ...
  DESCryptoProcessor DESCryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isBlank(secretKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by DESCryptoProcessor");
  ...
  SM2CryptoProcessor sm2CryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isAnyBlank(publicKeyHex, privateKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by SM2CryptoProcessor");
  ...
  SM4CryptoProcessor sm4CryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isBlank(secretKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by SM4CryptoProcessor");
  ...
  HmacSHA256DigestProcessor hmacSHA256CryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isBlank(secretKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by HmacSHA256DigestProcessor");
  ...
  HmacSHA512DigestProcessor hmacSHA512CryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isBlank(secretKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by HmacSHA512DigestProcessor");
  ...
  RSACryptoProcessor rsaCryptoProcessor(CryptoProperties properties) {
    ...
    if (StringUtils.isAnyBlank(publicKeyHex, privateKeyHex)) {
      log.trace(
          "[CRYPTO-HUTOOL] No secretKeyHex configured – key will be auto-generated by RSACryptoProcessor");
