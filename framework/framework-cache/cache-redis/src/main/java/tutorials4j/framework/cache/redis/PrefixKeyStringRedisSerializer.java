 ...
 * <p>
 * 该序列化器继承自 {@link StringRedisSerializer}，重写了 {@code serialize} 方法，
 * 在序列化前通过 {@link RedisUtils#defaultCacheKeyPrefix()} 计算出带租户、缓存名前缀的完整 Key，
 * 然后交给父类完成字符串到字节数组的转换。
 * </p>
 *
 * @author Yun Jiao
 * @see StringRedisSerializer
 * @see RedisUtils#defaultCacheKeyPrefix()
 */
