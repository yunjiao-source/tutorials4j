 ...
 *
 * <p>日志记录功能委托给 {@link tutorials4j.framework.common.core.util.HttpRequestUtils} 工具类， 通过 {@link
 * HttpRequestUtils#requestLogger(HttpRequest, byte[])} 和 {@link
 * HttpRequestUtils#responseLogger(ClientHttpResponse)} 方法完成。
 *
 * @author Yun Jiao
