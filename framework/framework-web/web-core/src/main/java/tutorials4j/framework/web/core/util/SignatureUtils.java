 ...
 * 签名工具类，提供签名生成和验证功能。
 * <p>
 * 签名算法采用 HmacSHA256，参与签名的参数包括 appKey、timestamp、nonce、method、path 和 body（可选），
 * 参数按字典序排序后拼接成 key=value 格式并以 & 连接。
 * </p>
 *
 * @author Yun Jiao
 */
public final class SignatureUtils {
     ...
     */
    public static String generate(String appKey, String appSecret, String timestamp, String nonce,
     ...
     * 构建待签名字符串。
     * <p>
     * 参数按字典序排序，格式为 key1=value1&key2=value2…，其中 body 仅在非空时加入。
     * </p>
     *
     * @param appKey    应用标识
     * @param timestamp 时间戳
     ...
     * @return 排序后拼接的参数字符串
     */
    private static String buildSignMessage(String appKey, String timestamp, String nonce,
                                           String method, String path, String body) {
        // 参数排序并拼接
