 ...
 * PropertiesConsts#PROPERTY_PREFIX_WEB_GOOGLE_AUTH} 定义）。
 *
 * <p>示例配置：
 *
 * <pre>
 ...
 */
@Data
@ConfigurationProperties(prefix = PropertiesConsts.PROPERTY_PREFIX_WEB_GOOGLE_AUTH)
public class GoogleAuthWebProperties {
