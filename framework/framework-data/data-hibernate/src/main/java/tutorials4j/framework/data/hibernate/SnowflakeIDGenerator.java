 ...
 * <p>
 * 将该注解标注在实体的主键字段或 getter 方法上，Hibernate 在持久化时会调用
 * {@link SnowflakeIdentifierGenerator} 生成分布式唯一 ID。
 * </p>
 * <p>
 * 支持的 ID 类型：
 * <ul>
 *     <li>{@code String}：生成 19 位十进制字符串</li>
 *     <li>{@code Long} 或数值类型：生成 {@code long} 型数值</li>
 * </ul>
 * </p>
 * <p>
 * 使用示例：
