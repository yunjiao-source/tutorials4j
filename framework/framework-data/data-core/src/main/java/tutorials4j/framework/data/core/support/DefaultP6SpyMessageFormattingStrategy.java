...
public class DefaultP6SpyMessageFormattingStrategy implements MessageFormattingStrategy {
    ...
    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern(DefaultConsts.DATE_TIME_FORMAT);

    @Override
    public String formatMessage(int connectionId, String now, long elapsed,
                                String category, String prepared, String sql, String url) {
        return String.format("[%s] | 连接ID: %d | 耗时: %sms | %s | SQL: %s",
